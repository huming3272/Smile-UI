<template>
  <div class="topnav">
    <router-link class="logo" to='/' v-if="logoShow"> 
    ...
    <svg class="icon toggleAside" aria-hidden="true"  v-if="toggleAside"  @click="toggleMenu">
...
export default {
  setup(){
    ...
    return {toggleMenu,toggleAside,toggleLogo}
  }
}
</script>
