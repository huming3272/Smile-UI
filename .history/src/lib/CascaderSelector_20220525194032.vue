  ...
  <div class="block">
    ...
    <span>
      ...
      <div class="cas" v-if="actId>-1 && source[actId].children">
        <IniCascader  v-model:source="source[actId].children" :activeId="activeId2" @patch="onPatch">
        </IniCascader>
      </div>
  </div>
</template>
...
import IniCascader from './CascaderSelector.vue'
...
export default {
  ...
  components:{
    IniCascader: defineAsyncComponent(() => import)
  },
  props: {
      source: {
          type: Array,
